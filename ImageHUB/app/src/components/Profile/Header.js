                ...
                <Grid item xs={4} className={classes.container}>
                    <Grid container>
                        ...
                        {props.profile.showFriendButton && (
                            <Grid item xs={4}>
                                <Button variant="outlined" onClick={() => handleClick(props.profile.userID)}>Add Friend</Button>
                            </Grid>
                        )}
                        ...
                        {props.profile.status == 3 && (
                            <Grid item xs={4}>
                                <Button variant="outlined" onClick={() => acceptClick(props.profile.userID)}>Accept friend</Button>
                            </Grid>
                        )}
                    </Grid>
                </Grid>
